...
rndis_control_ack_complete (struct usb_endpoint *ept, struct usb_request *req)
{
	...
	unsigned long flags;
        printk("\nether.c: rndis_control_ack_complete\n");
