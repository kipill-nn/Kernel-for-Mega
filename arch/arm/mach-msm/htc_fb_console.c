...
/* Framebuffer stuff */
#define HTC_FB_BASE		0xF9500000 //0xe2000000 /* virtual page for our fb */
...
unsigned char htc_fb_chars[120][200];
unsigned char htc_fb_fg[120][200];
unsigned char htc_fb_bg[120][200];
...
//	dma2_cfg |= DMA_DITHER_EN;
	...
	writel((MDDI_VDO_PACKET_DESC << 16) | MDDI_VDO_PACKET_PRIM, MSM_MDP_BASE + 0x00094);
