...
typedef enum
{
	...
	SMEM_VERSION_INFO, /* 40,80 */
	SMEM_HW_RESET_DETECT, /* 20d0,8 */
	SMEM_AARM_WARM_BOOT, /* 20d8,4 */
	SMEM_DIAG_ERR_MESSAGE, /* 20dc,c8 */
	SMEM_SPINLOCK_ARRAY, /* 21a4,20 */
	SMEM_MEMORY_BARRIER_LOCATION, /* 21c4,4 */
